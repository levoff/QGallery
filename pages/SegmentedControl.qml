...
Item {
    ...
    property string activeButtonColor: "gray"
    property string inactiveButtonColor: "#1C1C1E"
    ...
    Component.onCompleted: {
        ...
        for(var j in buttonsEnabled) {
            setButtonEnabled(j, buttonsEnabled[j])
        }
